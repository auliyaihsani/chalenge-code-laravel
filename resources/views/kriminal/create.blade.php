...
<form  action="{{ route('kriminal.store')}}" method="post" role="form" class="container" >
  {{ csrf_field() }} 
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <textarea class="form-control" rows="3" id="informasi" name="informasi" placeholder="Masukan informasi"></textarea>
      </div>
    </div> 
